...
function xml2phpArray($xml, $arr) {
    ...
    foreach ($xml->children() as $b) {
      ...
      if (!$b->children()) {
        ...
        $arr[$a][$iter] = array();
        $arr[$a][$iter] = xml2phpArray($b[0], $arr[$a][$iter]);
      }
    $i++;
    }
  return $arr;
...
//Searching for getOSDD
$request = "http://lance2.modaps.eosdis.nasa.gov/axis2/services/MWSLance/getOSDD?product=MOD04_L2";
...
echo "<b>getOSDD? for the following product : </b><br />";
var_dump($respObj);
$OSDDArray = xml2phpArray($respObj, array());
print_r($OSDDArray);
?>