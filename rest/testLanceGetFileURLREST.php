...
$request = "http://lance2.modaps.eosdis.nasa.gov/axis2/services/MWSLance/getDateCoverage?collection=1&product=MOD07_L2";
...
echo "<b>GetDateCoverage collection=1&product=MOD07_L2</b><br />";
$countReturns = $respObj->return->count();
for($i=0; $i<$countReturns; $i++){
  echo "File URL=" . $respObj->return[$i] . "<br />";
}
?>